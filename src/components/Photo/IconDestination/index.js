...
const IconDestination = (props) => {
	const { size, color, extended, style } = props;

	if (extended) {
		return (
			<svg style={style} x="0px" y="0px" width={size} height={size} viewBox="-546.5 1550.5 512 512" enableBackground="new -546.5 1550.5 512 512" space="preserve">
