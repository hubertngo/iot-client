...
export default function createGenerateClassName(options = {}) {
	...
	if (
		...
		if (generatorCounter > 2) {
			...
			console.error(
				[
					'DucTien Theme: we have detected more than needed creation of the class name generator.',
	...
	return (rule, styleSheet) => {
		...
		warning(
			ruleCounter < 1e10,
			[
				'DucTien Theme: you might have a memory leak.',
